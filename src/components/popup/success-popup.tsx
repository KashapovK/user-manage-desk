import icon from '../../assets/icons/сhecked-box.svg';
...
export function SuccessPopup({ onClose }: SuccessPopupProps) {
  return (
    <div className="edit-user-form__popup" onClick={onClose}>
      <div
        className="edit-user-form__popup-content"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="edit-user-form__popup-icon">
          <img src={icon} alt="Успешно" />
        </div>
        <span className="edit-user-form__popup-message">
          Изменения сохранены!
        </span>
        <button
          type="button"
